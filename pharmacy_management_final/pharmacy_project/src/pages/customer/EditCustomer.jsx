...
const EditCustomer = () => {
    ...
    useEffect(() => {
        axios.get("http://localhost/pharmacy_management/api-php/customer/getcustomer.php?id=" + id)
            .then((res) => {
    ...
    const save = () => {
        ...
        axios.post("http://localhost/pharmacy_management/api-php/customer/editcustomer.php", formdata, {
            headers: {
